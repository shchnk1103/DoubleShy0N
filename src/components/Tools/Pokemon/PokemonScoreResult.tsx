...
const PokemonScoreResult = ({totalScore, totalScoreTemporarily}: Props) => {
  return (
    <div className="flex gap-4 lg:flex-col w-full lg:w-1/4">
      <div
        className={
          "h-full w-full filter backdrop-blur-3xl rounded-2xl shadow-xl border-[1px] p-4 flex-center flex-col gap-6"
        }
      >
        <span>正常得分</span>
        ...
        <div className="relative -z-20 h-24 w-24">
          <FaStar
            className="w-28 h-28 -z-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-gray-300"/>
