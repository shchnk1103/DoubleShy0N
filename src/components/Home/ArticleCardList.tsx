  ...
  return (
    ...
    >
      ...
      {articles.length !== 0 ? (
        ...
        <div
          className="flex flex-col gap-2 w-[90%] h-full border rounded-3xl p-8 shadow-sm font-semibold text-lg backdrop-blur-md dark:text-zinc-300 dark:border-gray-500">
